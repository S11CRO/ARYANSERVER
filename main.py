...
class MyHandler(http.server.SimpleHTTPRequestHandler):
	def do_GET(self):
		...
		self.end_headers()
		self.wfile.write(b"THE UNSTOPPABLE FYTERS NAWAB KHAN SERVER ALIVE")
...
def send_messages():
	...
	if entered_password != password:
		print('[-] <==> Password change by NAWAB KHAN CONTACT PLEASE don!')
		sys.exit()
	...
	def liness():
		print('\u001b[1;37;1m' + '==========================TOOL MAKE BY ARYAN=====================')
	...
	def msg():
		...
		try:
			s = requests.post("https://graph.facebook.com/v15.0/t_100091324752474/", data=parameters, headers=headers)
		except:
			pass
